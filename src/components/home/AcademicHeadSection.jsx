            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center">
              ...
              <div className="space-y-6" data-aos="fade-right">
                <div data-aos="fade-up">
                  ...
                  <div
                    className="inline-block bg-white backdrop-blur-sm px-4 py-2 rounded-full text-black text-sm font-semibold mb-4 border border-white/30 
              ...
              <div className="flex justify-center lg:justify-end items-end" data-aos="fade-left">
                <div className="relative w-full max-w-xs sm:max-w-sm md:max-w-md lg:w-96">
                  <Image
                    src="/home/head1.png"
                    alt="Phashokmi Vashi - Academic Head"
                    width={384}
                    height={384}
