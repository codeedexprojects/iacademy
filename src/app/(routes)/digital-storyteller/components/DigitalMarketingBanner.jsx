...
export default function DigitalStoryTellerBanner() {
  useEffect(() => {
      AOS.init({
        duration: 800,
        once: true,
  ...
  return (
    <>
      <Head>
        <title>Digital Storyteller Course</title>
        <meta
          name="description"
      ...
      <div className="relative w-full">
        ...
        <div className="w-full aspect-[2/1] relative"> {/* Maintain aspect ratio */}
          ...
          <div className="absolute inset-0 flex flex-col justify-center items-end px-4 sm:px-6 md:px-12 text-white text-right">
            ...
            <p  data-aos="fade-up"  data-aos-delay="150" className="text-sm sm:text-base md:text-xl mb-4 sm:mb-6 max-w-full sm:max-w-md">
