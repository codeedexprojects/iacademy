...
export default function StudentDesignerBanner() {
  ...
  return (
    <>
      <Head>
        <title>Creative student designer</title>
        <meta
          name="description"
          content="Creative student designer to create engaging, innovative, and user-centric digital experiences for students"
        />
      </Head>
        ...
        <div className="w-full aspect-[2/1] relative"> 
          ...
          <div className="absolute inset-0 flex flex-col justify-center items-start px-4 sm:px-6 md:px-12 text-white">
            ...
            <p  data-aos="fade-up"
              ...
              Creative student designer to create engaging, innovative, and user-centric digital experiences for students
            </p>
            <button
            onClick={handleClick}
             data-aos="fade-up"
